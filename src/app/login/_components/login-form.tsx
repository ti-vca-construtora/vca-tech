...
import logoTech from "../../../../public/assets/logo-tech-mobile.jpg";
...
export function LoginForm() {
  ...
  return (
    <>
      <Card className="w-[95%] md:w-[600px] bg-neutral-50 px-2 md:px-16 h-[88%] md:h-full flex flex-col justify-between">
